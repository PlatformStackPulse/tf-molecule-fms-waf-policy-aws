...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_fms_admin"></a> [fms\_admin](#module\_fms\_admin) | git::https://github.com/PlatformStackPulse/tf-atom-fms-admin-account-aws.git | v1.1.0 |
| <a name="module_fms_policy"></a> [fms\_policy](#module\_fms\_policy) | git::https://github.com/PlatformStackPulse/tf-atom-fms-policy-aws.git | v1.1.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_admin_account_id"></a> [admin\_account\_id](#input\_admin\_account\_id) | AWS account ID to delegate as FMS administrator. | `string` | `""` | no |
...
| <a name="input_exclude_account_ids"></a> [exclude\_account\_ids](#input\_exclude\_account\_ids) | List of AWS account IDs to exclude. | `list(string)` | `[]` | no |
...
| <a name="input_include_account_ids"></a> [include\_account\_ids](#input\_include\_account\_ids) | List of AWS account IDs to include. Empty means all. | `list(string)` | `[]` | no |
...
| <a name="input_managed_service_data"></a> [managed\_service\_data](#input\_managed\_service\_data) | JSON managed service data for the FMS policy (WAF rule groups config). | `string` | `null` | no |
...
| <a name="input_remediation_enabled"></a> [remediation\_enabled](#input\_remediation\_enabled) | Whether auto-remediation is enabled. | `bool` | `false` | no |
| <a name="input_resource_type"></a> [resource\_type](#input\_resource\_type) | Resource type to protect (e.g. AWS::ElasticLoadBalancingV2::LoadBalancer). | `string` | `"AWS::ElasticLoadBalancingV2::LoadBalancer"` | no |
| <a name="input_resource_type_list"></a> [resource\_type\_list](#input\_resource\_type\_list) | List of resource types for the FMS policy. | `list(string)` | `[]` | no |
| <a name="input_set_admin_account"></a> [set\_admin\_account](#input\_set\_admin\_account) | Whether to set the FMS admin account. Only needed once per org. | `bool` | `false` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_fms_policy_arn"></a> [fms\_policy\_arn](#output\_fms\_policy\_arn) | The ARN of the FMS policy. |
| <a name="output_fms_policy_id"></a> [fms\_policy\_id](#output\_fms\_policy\_id) | The ID of the FMS policy. |
<!-- END_TF_DOCS -->
